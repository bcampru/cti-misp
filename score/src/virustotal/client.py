...
class VirusTotalClient:
    ...
    def _query(self, url):
        ...
        #     print(f"[VirusTotal] Http error: {errh}")
        # except requests.exceptions.ConnectionError as errc:
        #     print(f"[VirusTotal] Error connecting: {errc}")
        # except requests.exceptions.Timeout as errt:
        #     print(f"[VirusTotal] Timeout error: {errt}")
        # except requests.exceptions.RequestException as err:
        #     print(f"[VirusTotal] Something else happened: {err}")
        # except Exception as err:
        #     print(f"[VirusTotal] Unknown error {err}")
        try:
